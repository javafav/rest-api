...
public class MainController {
	...
	private RootEntity createRootEntity() {
		...
		String realtimeWeatherByCodeUrl = linkTo(
				methodOn(RealtimeWeatherApiController.class).getRealtimeByLocationCode(null)).toString();
		...
		String hourlyForecastByCodeUrl = linkTo(
				methodOn(HourlyWeatherApiController.class).listHourlyWeatherForecastByLocationCode(null, null)).toString();
		entity.setHourlyForecastByCodeUrl(hourlyForecastByCodeUrl);
		
		String dailyForecastByIpUrl = linkTo(
				methodOn(DailyWeatherApiController.class).listDailyForecastByIPAdress(null)).toString();
